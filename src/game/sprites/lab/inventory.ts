...
export const INVENTORY: LabAsset[] = [
  ...
  // ── 8.4 Hair ──────────────────────────────────────────────────────────────
  {
    ...
    promptSeed:
      "Messy dark kid hair, slightly too long in front, no face pixels, transparent everywhere except hair",
    model: "pixen",
    layer: "hair",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Simple dark short hair, teen/adult default, no face pixels, transparent everywhere except hair",
    model: "style",
    styleRef: "hair-child",
    layer: "hair",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Army buzz cut, scalp shows through, 2-3 pixel stubble, no face pixels, transparent everywhere except hair",
    model: "style",
    styleRef: "hair-short",
    layer: "hair",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Grown-out trip hair, a bit greasy, still dark, no face pixels, transparent everywhere except hair",
    model: "style",
    styleRef: "hair-short",
    layer: "hair",
    noBackground: true,
  ...
  // ── 8.5 Expressions ───────────────────────────────────────────────────────
  {
    ...
    promptSeed:
      "Face pixels only: flat mouth, two-pixel eyes, calm, transparent everywhere except face box x22-41 y8-18",
    model: "pixen",
    layer: "expression",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Face pixels only: small grin, squinted eyes, transparent everywhere except face box",
    model: "style",
    styleRef: "expression-neutral",
    layer: "expression",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Face pixels only: tight mouth, inner brows raised, transparent everywhere except face box",
    model: "style",
    styleRef: "expression-neutral",
    layer: "expression",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Face pixels only: round mouth, white round eyes, one-frame cartoon still tiny, transparent everywhere except face box",
    model: "style",
    styleRef: "expression-neutral",
    layer: "expression",
    noBackground: true,
  },
  {
    ...
    promptSeed:
      "Face pixels only: half-lidded eyes, tiny smirk, transparent everywhere except face box",
    model: "style",
    styleRef: "expression-neutral",
    layer: "expression",
    noBackground: true,
